...
public class UserRequestDto {
  ...
  private static final String PASSWORD_SIZE_VALIDATION_MSG = "Size must be at least 8 characters";
  ...
  private static final String PASSWORD_PATTERN_VALIDATION_MSG =
  ...
  @Size(min = 8, message = PASSWORD_SIZE_VALIDATION_MSG)
  @Pattern(regexp = PASSWORD_PATTERN_REGEX, message = PASSWORD_PATTERN_VALIDATION_MSG)
