...
class AllowedValueCrudIntegrationTest extends AuthenticatedIntegrationTestBase {
  ...
  void canAddAndFetchAllowedValue() throws Exception {
    ...
    AllowedValueRequestDto requestDto = new AllowedValueRequestDto("Metal", "color", "gold", "G");
    ...
    List<AllowedValueResponseDto> values =
  ...
  void canDeleteAllowedValue() {
    ...
    AllowedValueRequestDto requestDto = new AllowedValueRequestDto("Metal", "color", "silver", "S");
    testRestTemplate.postForEntity(baseUrl, requestDto, String.class);
    ...
    ResponseEntity<Void> deleteResponse =
        testRestTemplate.exchange(baseUrl, HttpMethod.DELETE, request, Void.class);
  ...
  void deleteNonExistentAllowedValueReturns404() {
    AllowedValueRequestDto nonExistentDto =
        new AllowedValueRequestDto("NonExistent", "field", "value", "N");
